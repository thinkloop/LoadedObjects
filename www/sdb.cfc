...
Released March 2008
By David Smith (dcsmith@hotmail.com)
License: Apache License, Version 2 (http://www.apache.org/licenses/LICENSE-2.0)

Updated May 2009
By Bassil Karam (simpledb@thinkloop.com)
License: Apache License, Version 2 (http://www.apache.org/licenses/LICENSE-2.0)
	- re-ordered arguments for putAttributes() to match those of getAttributes()
	- added comments
	- decreased spacing between functions
...
--->
    ...
    <cffunction name="init" output="false" returntype="sdb"  hint="Returns an instance of the CFC initialized.">
    ...
    <cffunction name="createDomain" output="true" returntype="string">
		...
		<cfif CFHTTP.ResponseHeader.Status_Code neq 200>
            <cfinvoke method="handleErrors" content="#CFHTTP.FileContent#"/>
        <cfelse>
        ...
        <cfloop from="1" to="#ArrayLen(myNameArray)#" index="i">
			<cfif #myNameArray[i]# eq "">#deleteAttributes(Arguments.domainName, Arguments.itemName)#<cfelse>
				<cfif #myNameArray[i]# CONTAINS "attribute.">
                    ...
                    <cfset index = index-1/>
                <cfelse>
<cfdump var="#attributeNameValuePairs#">			
