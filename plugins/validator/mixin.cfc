...
<cfcomponent output="false">
	...
	<cffunction name="validateProperty" access="public" output="false" returntype="any">
		...
		<cfelse>
			<cfthrow type="LoadedObjects" errorcode="LoadedObjects.ValidateProperty.UndefinedProperty" message="Could not validate property #ucase(arguments.PropertyName)# because it was not found in component #ucase(getMetaDataObject().getPath())#" detail="Ensure that the property is defined, and that it is spelled correctly." />
		</cfif>
